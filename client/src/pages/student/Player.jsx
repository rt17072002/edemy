  ...
  const getCourseProgress = async () => {
    try {
      ...
      if (data.success) {
        ...
        // console.log("Progress data is : "+data.progressData);
      } else {
        toast.error(data.message);
      }
    } catch (error) {
            ...
            ? (
              <div>
                ...
                <div className='flex justify-between'>
                  ...
                  <button className='text-blue-600' onClick={()=>markLectureAsCompleted(playerData.lectureId)}>{progressData && progressData?.lectureCompleted?.includes(playerData.lectureId) ? "Completed" : "Mark complete"}</button>
                </div>
              </div>
            )
