...
export const dummyCourses = [
    {
        ...
        "courseTitle": "Introduction to JavaScript",
        "courseDescription": "<h2>Learn the Basics of JavaScript</h2><p>JavaScript is a versatile programming language that powers the web. In this course, <br/> you will learn the fundamentals of JavaScript, including syntax, data types, and control <br/> structures.</p><p>This course is perfect for beginners who want to start their journey in web <br/> development. By the end of this course, you will be able to create interactive web pages <br/> and understand the core concepts of JavaScript.</p><ul><li>Understand the basics of programming</li><li>Learn how to manipulate the DOM</li><li>Create dynamic web applications</li></ul>",
        "coursePrice": 49.99,
        "isPublished": true,
        "discount": 20,
        "courseContent": [
